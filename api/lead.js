...
// ----------------------------------------------------------------------------
// This is V2 (WITH free-trial messaging). V1 (no trial) is the twin page at
// join.coconutva.com. Same code, same Slack channel, same env — only the tag,
// source label, and page URL differ.
const LEAD_TAG    = 'LM - Steal Your Time Back V2';
const SOURCE_INFO = 'Landing Page — Steal Your Time Back V2 (info.coconutva.com)';
const PAGE_URL    = process.env.PAGE_URL || 'https://info.coconutva.com/';
// ----------------------------------------------------------------------------
